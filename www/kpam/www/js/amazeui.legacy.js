  ...
  5: [
    function(require, module, exports) {
      (function(global) {
        ...
        // TODO: ??¡ä?£¤???? target ¨¦€¡ë????¨C1???
        //       ????? ?????1??¡§??¡­¨¦???2???¡ë border/padding ?¡ë?¨¨???-¡ê????¡è?????????|?????¡§?¡±??????¡ë??€?o??¡ã?¨¦¡ª?¨¦¡é?
        //       ?¡¥??¡ë???¡ä?£¤??????a??£¤¨¦???o| transition ??¡§?¡±?¨¨¡ì¡ê??3?¨C1??????max-height ?1??¡À?????¡ã¡À??¡ª?o?
      ...
      (function(global) {
        ...
        Modal.prototype.close = function(relatedTarget) {
          ...
          var complete = function() {
            ...
            $element.hide();
            this.transitioning = 0;
            // ?????o????¡­3¨¦¡ª- Dimmer?????£¤????¡è???a Modal ??¡¥??£¤?¡­¡À?o? Dimmer
    ...
    function(require, module, exports) {
      (function(global) {
        ...
        Popover.prototype.sizePopover = function sizePopover() {
          ...
          // ??¨C?????¡ã $popCaret.outerHeight() ????€?????¡ë€??£¤??¡ä??£¤??  8
