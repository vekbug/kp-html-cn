var ApKit = (function () {
    var ApKit = {
        config: {
            download_director_url: '/n/down/',
            download_alternate_url_android: 'http://public.chaobang.com/union/guide/android/?c=default',
        ...
        action: {
            download: {
                ...
                byDirectorPage: function () {
                    location.href = ApKit.config.download_director_url + window.location.hash;
                },
                ...
                noticeOpenOnSystemBrowser: function (timeout_microseconds) {
                    ...
                    setTimeout(function () {
                        if (
                            ...
                            ApKit.tool.env.isWeibo || ApKit.tool.env.isLianXin
                        ) {
